package cat.itacademy.barcelonactiva.PORTABELLASUSANA.s04.t02.n01.S04T02N01PORTABELLASUSANA.controllers;

import cat.itacademy.barcelonactiva.PORTABELLASUSANA.s04.t02.n01.S04T02N01PORTABELLASUSANA.model.domain.Fruit;
import cat.itacademy.barcelonactiva.PORTABELLASUSANA.s04.t02.n01.S04T02N01PORTABELLASUSANA.model.services.FruitService;
...
public class FruitController {
    ...
    public ResponseEntity<Fruit> addFruit(@RequestBody Fruit f) {
        ...
        try {
            Fruit fruit = new Fruit(f.getName(), f.getQuantity());
